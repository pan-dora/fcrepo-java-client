...
public class FcrepoHttpClientBuilder {
     ...
     */
    public FcrepoHttpClientBuilder(final String username, final String password, final String
            host) {
    ...
    static class PreemptiveAuthInterceptor implements HttpRequestInterceptor {
        ...
        public void process(final HttpRequest request, final HttpContext context) throws
            ...
            final AuthState authState = (AuthState) context.getAttribute(HttpClientContext
                    .TARGET_AUTH_STATE);
            ...
            if (authState.getAuthScheme() == null) {
                ...
                final HttpHost targetHost = (HttpHost) context.getAttribute(HttpCoreContext
                        .HTTP_TARGET_HOST);
                final AuthScope authScope = new AuthScope(targetHost.getHostName(), targetHost
                        .getPort());
                final Credentials creds = credsProvider.getCredentials(authScope);
                if (creds == null) {
                    LOGGER.debug("Cannot initiate preemtive authentication, Credentials not " +
                            "found!");
                }
