...
public class FcrepoClientTest {
    ...
    public void testGet300() throws Exception {
        ...
        final Header linkHeader = new BasicHeader("Link", "<" + redirect + ">; " +
                "rel=\"describedby\"");
    ...
    private CloseableHttpResponse doSetupMockRequest(final String contentType, final
    ...
    private CloseableHttpResponse doSetupMockRequest(final String contentType, final
    ByteArrayEntity entity,
                                                     final int status, final String statusPhrase)
            throws IOException {
