...
public class PutBuilderTest {
    ...
    public void testPutNoBody() throws Exception {
        ...
        final ArgumentCaptor<HttpRequestBase> requestCaptor = ArgumentCaptor.forClass
    ...
    public void testWithBody() throws Exception {
        ...
        assertEquals("attachment; filename=\"file.txt\"", request.getFirstHeader
                (CONTENT_DISPOSITION).getValue());
    }
    ...
    public void testPostClientError() throws Exception {
        Assertions.assertThrows(FcrepoOperationFailedException.class, () -> {
            when(client.executeRequest(any(URI.class), any(HttpRequestBase.class)))
    ...
    public void testPreferLenient() throws Exception {
        ...
        final HttpEntityEnclosingRequestBase request = (HttpEntityEnclosingRequestBase)
                requestCaptor.getValue();
        assertEquals("handling=lenient; received=\"minimal\"", request.getFirstHeader(PREFER)
                .getValue());
    }
}
