...
public class FcrepoClientIT extends AbstractResourceIT {
    ...
    public void testPostBinary() throws Exception {
        ...
        assertEquals("Location did not match slug", serverAddress + slug, response.getLocation()
                .toString());

        assertNotNull("Didn't find linked description!", response.getLinkHeaders("describedby")
                .get(0));
    ...
    public void testPostDigestMismatch() throws Exception {
        ...
        assertEquals("Invalid checksum was not rejected", CONFLICT.getStatusCode(), response
                .getStatusCode());
    }
    ...
    public void testGetDisableRedirects() throws Exception {
        ...
        final String mimetype = "message/external-body; access-type=URL; URL=\"http://www.example" +
                ".com/file\"";
        final FcrepoResponse response = client.post(new URI(serverAddress))
